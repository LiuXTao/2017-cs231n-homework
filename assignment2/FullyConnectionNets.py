...
# plt.plot([0.5]*len(solver.val_acc_history),'k--')   # 画标志线
# plt.xlabel('Epoch')
...
# model = FullyConnectedNet([H1,H2,H3,H4],
...
# }
# solvers = {}
# #'sgd':1e-3,'sgd_momentum'=1e-3,
# learning_rates={'sgd':1e-3,'sgd_momentum':1e-3,'rmsprop':1e-4,'adam':1e-3}
